# Contributing to BOSS - Big Open Source Sister GitHub Pages

We would love for you to contribute to `Big Open Source Sister GitHub Pages` and help make it even better than it is today! As a contributor, here are the guidelines we would like you to follow:
...
Do not open issues for general support questions as we want to keep GitHub issues for bug reports and feature requests. You've got much better chances of getting your question answered on [Stack Overflow](https://stackoverflow.com/questions/tagged/) where the questions should be tagged with tag `github pages`.
...
<!-- TODO: Add communication platform -->
If you would like to chat about the question in real-time, you can reach out via our **ADD COMMUNICATION CHANNEL HERE**.
